...
constants.CANVAS.WIDTH = (window.innerWidth * constants.CANVAS.WIDTH_PERCENTAGE) / 100,
constants.CANVAS.HEIGHT = (window.innerHeight * constants.CANVAS.HEIGHT_PERCENTAGE) / 100, 
